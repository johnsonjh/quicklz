...
// compressed (see manual). If QLZ_STREAMING_BUFFER > 0, scratch buffers must
// be initially zeroed out (see manual). First #ifndef makes it possible to
// define settings from the outside like the compiler command line.
...
# endif /* ifndef QLZ_COMPRESSION_LEVEL */
...
# endif /* if QLZ_COMPRESSION_LEVEL != 1 && QLZ_COMPRESSION_LEVEL != 2 && QLZ_COMPRESSION_LEVEL != 3 */
...
#  define QLZ_PTR_64
# endif /* if defined _LP64 || defined __LP64__ || defined __64BIT__ || _ADDR64 || defined _WIN64 || defined __arch64__ || __WORDSIZE == 64 || ( defined __sparc && defined __sparcv9 ) || defined __x86_64 || defined __amd64 || defined __x86_64__ || defined _M_X64 || defined _M_IA64 || defined __ia64 || defined __IA64__ */
